...
?>
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <h1>Let's Share Happiness :)</h1>
            <p>Flat 30% OFF on premium brands </p>
            <a href="products.php" class="btn btn-warning btn-lg text-white">Explore Now</a>
 ...
 <div class="container pt-3">
        <div class="row text-center ">
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#Sharees">
                 <img src="images/sharee" class="img-fluid  " alt="" style="border-radius:0.5rem">
                 <div class="h5 pt-3 font-weight-bolder">
                 Sarees
                 </div>
              </div>
